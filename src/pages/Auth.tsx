                    ...
                    <div className="relative mt-1">
                      ...
                      <Input
                        ...
                        className={`pl-10 pr-10 bg-white/10 border-white/15 text-white placeholder:text-white/30 rounded-xl ${
                          newPassword && confirmNewPassword && newPassword === confirmNewPassword ? "border-emerald-400/50" : newPassword && confirmNewPassword && newPassword !== confirmNewPassword ? "border-red-400/50" : ""
                        }`}
                      />
