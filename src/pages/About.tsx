          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card rounded-xl p-6 md:p-8 shadow-soft">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our goal is simple: <span className="font-semibold text-foreground">make giving easier, 
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-secondary rounded-xl p-6 md:p-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                thoughtful donor in mind—<span className="font-semibold text-foreground">someone 
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card rounded-xl p-6 md:p-8 shadow-soft mb-6">
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                We use a <span className="font-semibold text-foreground">dual rating system</span> that 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="border border-border rounded-xl p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-foreground">GiveWiZe Score</h3>
                  </div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      <span><strong className="text-foreground">Financial Efficiency</strong> — Percentage of funds going to programs</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Eye className="h-4 w-4 text-primary mt-0.5" />
                      <span><strong className="text-foreground">Transparency</strong> — Availability of financial reports and audits</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Shield className="h-4 w-4 text-primary mt-0.5" />
                      <span><strong className="text-foreground">Longevity</strong> — Track record and organizational stability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Heart className="h-4 w-4 text-primary mt-0.5" />
                      <span><strong className="text-foreground">Impact</strong> — Measurable outcomes and effectiveness</span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-secondary rounded-xl p-6 md:p-8 mb-8">
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                We envision a future where <span className="font-semibold text-foreground">every 
